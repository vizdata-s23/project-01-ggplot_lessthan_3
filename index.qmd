...
Collegiate sports refers to organized athletic programs in colleges and universities that compete against each other in various sports. These programs generate significant revenue through ticket sales, merchandise, sponsorships, and media rights. However, collegiate sports also come with significant expenditures, such as scholarships, salaries for coaches and staff, facilities, travel, and equipment. Unfortunately, there is often a gender disparity in how revenue and expenditures are allocated in collegiate sports. In many cases, men's sports programs generate much more revenue than women's programs, but both genders receive similar funding for expenses. Through our project, we hope to investigate and analyze the different trends in the budget of collegiate sports across the years and gain new understanding about not only what influences the budgets of these sports programs but also how trends and patterns vary on different factors.
