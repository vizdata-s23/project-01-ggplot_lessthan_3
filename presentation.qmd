...
The data includes information on every college sports program from 2015-2019, including expenditure and revenue generated from different sports
...
plotdf_pivoted <- plotdf |> 
  ...
  mutate(gender = 
           case_when(category == "mean_exp_men" | category == "mean_rev_men" ~ "Mens",
                     category == "mean_exp_women" | category == "mean_rev_women" ~ "Womens"),
         type = 
           case_when(category == "mean_exp_men" | category == "mean_exp_women" ~ "Expenditure",
